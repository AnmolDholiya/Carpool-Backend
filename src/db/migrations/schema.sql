...
CREATE TABLE rides (
    ...
    ride_date DATE NOT NULL CHECK (ride_date >= CURRENT_DATE),
    ...
    status VARCHAR(15) CHECK (status IN ('ACTIVE', 'CANCELLED', 'COMPLETED')),
...
CREATE TABLE bookings (
    ...
    booking_status VARCHAR(15) CHECK (booking_status IN ('CONFIRMED', 'CANCELLED', 'COMPLETED')),
