...
export async function registerUser(input: {
  ...
  const result = await pool.query(
    `INSERT INTO users (full_name, email, phone, password, role, profile_photo)
     VALUES ($1, $2, $3, $4, 'USER', $5)
     RETURNING user_id, full_name, email, phone, role, profile_photo, email_verified, created_at`,
    [
      input.full_name,
      input.email,
      input.phone,
